...
const UpsertBuildValidationPolicyArgs = z.object({
...
function policyWebUrl(repositoryId, branch) {
  ...
  return `${TFS_URL}/${TFS_COLLECTION}/${TFS_PROJECT}/_settings/repositories?repo=${repositoryId}&refName=${encodedBranch}&view=policies`;
}
